...
export default function QuantitySelector({
  ...
  return (
    <Stack direction="horizontal" className="mb-0">
      <Button onClick={handleQuantityMinusOne} disabled={isLoading || quantity <= 1}
              className="btn-sm btn-secondary"> - </Button>
      ...
      <Button onClick={handleQuantityPlusOne} disabled={isLoading || quantity >= stock}
              className="btn-sm btn-secondary"> + </Button>
    </Stack>
  )
}